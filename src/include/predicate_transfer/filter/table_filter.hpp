...
//! Adapts a Bloom-owned bloom or bitmap filter to DuckDB's expression table-filter API.
...
public:
	...
	unique_ptr<ExpressionFilter> GetFilter(float selectivity_threshold = 1.0f, idx_t n_vectors_to_check = 6) const;
